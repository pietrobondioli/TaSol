...
public class User : BaseAuditableEntity
{
    ...
    [Required] public string Role { get; set; } = Roles.User;
    ...
    [Required] public long MetadataId { get; set; }

    [ForeignKey(nameof(MetadataId))] public virtual UserMetadata Metadata { get; set; } = null!;
